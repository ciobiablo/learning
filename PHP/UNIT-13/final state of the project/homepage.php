...
<form action="" method="get">
    <input type="text" class="tarih" name="baslangic"
           value="<?php echo isset($_GET['baslangic']) ? $_GET['baslangic'] : '' ?>" placeholder="Başlangıç Tarihi">
    <input type="text" class="tarih" name="bitis" value="<?php echo isset($_GET['bitis']) ? $_GET['bitis'] : '' ?>"
           placeholder="Bitiş Tarihi"> <br>
    <input type="text" value="<?php echo isset($_GET['arama']) ? $_GET['arama'] : '' ?>" name="arama"
           placeholder="Derslerda ara..">
