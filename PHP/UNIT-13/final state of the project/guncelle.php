...
<form action="" method="post">
    ...
    Başlık: <br>
    <input type="text" value="<?php echo isset($_POST['baslik']) ? $_POST['baslik'] : $ders['baslik'] ?>" name="baslik">
    <br> <br>

    İçerik: <br>
    <textarea name="icerik" cols="30"
              rows="10"><?php echo isset($_POST['icerik']) ? $_POST['icerik'] : $ders['icerik'] ?></textarea> <br> <br>

    Kategori: <br>
    <select name="kategori_id[]" multiple size="5">
        <?php foreach ($kategoriler as $kategori): ?>
            <option <?php echo in_array($kategori['id'], $dersKategoriler) ? ' selected' : '' ?>
                    value="<?php echo $kategori['id'] ?>"><?php echo $kategori['ad'] ?></option>
        <?php endforeach; ?>
    </select> <br> <br>
